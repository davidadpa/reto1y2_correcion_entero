...
import java.util.InputMismatchException;// agregue esta libreria pensando que nos servia, es para la excepecion de si esuna letra reornar que el ususario pongaun umero
/**
 *
...
// este es el codigo que nos propuso victor
public static boolean isNumeric(String str){
 try {
    ...
    return true;
     ...
     return false;
 }// aqui termina el codigo propuesto por victor
}
    public void iniciarPrograma() {
        ...
        do {
            ...
            if (tipoOperacion.equals("1")) {
               ...
               // aqui se agrega la condicion nueva
                boolean condicion1 = isNumeric(cadenaNumero);
                try{
                    condicion1 = false;
